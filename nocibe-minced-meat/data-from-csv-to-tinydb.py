...
file = open("timeout.txt", "a")  # Temp file if program crash to get timeout URL

with open('hrefs-nocibe.csv', newline='') as csvfile:
    nocibe_csv_reader = csv.reader(csvfile, delimiter=',', quotechar='|')
    nocibe_csv_reader.__next__()  # Skipping the headers
    skipped = 0
